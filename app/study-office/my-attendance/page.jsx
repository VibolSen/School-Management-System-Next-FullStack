...
export default function StudyOfficeMyAttendancePage() {
  const { user } = useUser();
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold text-slate-800">My Attendance (Study Office)</h1>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="text-md text-slate-600 mb-6">
          ...
          {attendanceRecord?.status === 'LATE' && (
            <p className="text-sm text-red-500 mt-2">Status: {attendanceRecord.note}</p>
          )}
        </div>
