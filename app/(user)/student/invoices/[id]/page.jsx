...
import StudentInvoiceDetailView from "@/components/student/StudentInvoiceDetailView";
...
const StudentInvoiceDetailPage = () => {
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <Link href="/student/invoices" className="inline-flex items-center text-blue-600 hover:underline mb-6">
